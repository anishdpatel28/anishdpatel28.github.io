          ...
          <Tooltip key={skill.name} title={skill.name} arrow>
            <Box
              ...
              sx={{
                ...
                borderRadius: 2,
                backgroundColor: textAlpha(mode, 0.08, 0.15),
                ...
                '&:hover, &:focus-visible': {
                  ...
                  backgroundColor: textAlpha(mode, 0.18, 0.25),
                  outline: '2px solid',
            ...
            >
              {skill.icon ? skill.icon : (
                <Box sx={{ width: 40, height: 40, background: textAlpha(mode, 0.15, 0.2), borderRadius: 1 }} />
              )}
            </Box>
          </Tooltip>
        ))}
