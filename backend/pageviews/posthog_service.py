...
class PostHogService:
    def __init__(self):
        ...
        if self.api_key:
            ...
            logger.warning("PostHog API key not configured. Analytics will only be stored locally.")
    
    def capture_page_view(self, user_id: Optional[str] = None, properties: Optional[Dict[str, Any]] = None):
    ...
    def capture_section_time(self, section: str, time_spent: int, user_id: Optional[str] = None):
